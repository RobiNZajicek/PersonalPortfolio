  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        variants={fadeInUp}
      >
        <h1 className='text-[22px] sm:text-[25px] md:text-[30px] lg:text-[40px] xl:text-[45px] Dosxl:text-[50px] font-black text-center glow-text'>
          Why Work With Me
        </h1>
        <a href={Cv} download
      ...
      >
        ...
        >
          ...
          <span className='font-normal text-[15px] sm:text-[16px] md:text-[15px] lg:text-[18px] xl:text-[18px] Dosxl:text-[18px] z-50 text-[#BDBDBD] text-center w-[250px] md:w-full font-sans mb-8'>
            X years of proven industry experience
          </span>
        </motion.div>
        ...
        >
          ...
          <span className='font-normal text-[15px] sm:text-[16px] md:text-[15px] lg:text-[18px] Dosxl:text-[20px] z-50 text-[#BDBDBD] text-center w-[250px] md:w-3/6 font-sans mb-8'>
